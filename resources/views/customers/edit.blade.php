        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4">
                <div class="pt-3 pb-2 mb-3">
                    ...
                    <form action="{{ route('customers.update', $customer->id) }}" method="POST" class="container mt-4">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ old('phone_number', $customer->phone_number) }}" required>
                            @error('phone_number')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
