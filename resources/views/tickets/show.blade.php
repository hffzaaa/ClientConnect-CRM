                    ...
                    <div class="container mt-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">{{ ucwords(strtoupper($ticket->customer->name)) }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <strong>Description:</strong> <span>{{ ucwords(strtolower($ticket->description)) }}</span>
                                </div>

                                <div class="mb-3">
                                    <strong>Status:</strong> <span>{{ ucwords(strtolower($ticket->status)) }}</span>
                                </div>

                                <div class="mb-3">
                                    <strong>Priority:</strong> <span>{{ ucwords(strtolower($ticket->priority)) }}</span>
                                </div>

                                <div class="mb-3">
                                    <strong>Assigned To:</strong> <span>{{ $ticket->user ? $ticket->user->name : 'Unassigned' }}</span>
                                </div>
                            </div>
